package com.fathkim.mynoteapps.UI.insert
...
import com.fathkim.mynoteapps.R
import com.fathkim.mynoteapps.databinding.ActivityNoteAddUpdateBinding
import com.fathkim.mynoteapps.helper.DateHelper
import com.fathkim.mynoteapps.helper.ViewModelFactory
            ...
            when {
                ...
                description.isEmpty() -> {
                    ...
                    if (isEdit) {
                        ...
                        note.let { note ->
                            note?.date = DateHelper.getCurrentData()
                        }
